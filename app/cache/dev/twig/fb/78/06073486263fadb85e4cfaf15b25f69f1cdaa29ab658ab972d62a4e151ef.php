...
/* GeneQuestionnaireBundle:User:user_spanish.html.twig */
class __TwigTemplate_fb7806073486263fadb85e4cfaf15b25f69f1cdaa29ab658ab972d62a4e151ef extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 8
        echo "    
        <h2>Cuéntanos acerca de ti…</h2>
        <form action=\"";
        // line 10
        echo $this->env->getExtension('routing')->getPath("gene_questionnaire_user_save_es");
        echo "\" method=\"post\">
            <div>
                ";
        // line 12
        ...
        echo "
                ...
                <select name=\"ethnicity\" onclick=\"show4()\">
                    ...
                    <option value=\"African/African American\">Afroamericano/Africano</option>
                    <option value=\"Asian Indian\">Indio asiático</option>
                    <option value=\"Caucasian (European)\">Caucásico (europeo)</option>
                    <option value=\"Caucasian (Middle East)\">Caucásico (medio oriente)</option>
                    <option value=\"Hispanic, Latino or Spanish\">Hispano, latinoamericano o español</option>
                    <option value=\"Indigenous Australian\">Indígena australiano</option>
                    <option value=\"Native American\">Nativo americano</option>
                    <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">Del noreste asiático (mongol, tibetano, coreano, japonés, etc.)</option>
                    <option value=\"Pacific (Polynesian, micronesian, etc)\">Del Pacífico (polinesio, micronesio, etc.)</option>                
                    <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">Del sudeste asiático (chino, tailandés, malayo, filipino, etc.)</option>
                </select>
            </div>
                <br>
        ...
        echo "
                ...
                <br>
                <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">Si

                <div id=\"religious_yes\" style=\"display:none;\">
                    <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">

                        <option value=\"Christian - Protestant/Anglican\">Cristianismo (protestante/anglicano)</option>
                        <option value=\"Christian - Catholic\">Cristianismo (católico)</option>
                        <option value=\"Christian - Other\">Cristianismo (otra)</option>
                        <option value=\"Muslim\">Islamismo</option>
                        <option value=\"Jewish\">Judaísmo</option>
                        <option value=\"Buddhist\">Budismo</option>
                        <option value=\"Hindu\">Hindú</option>
                        <option value=\"Shinto\">Shinto</option>
                        <option value=\"Taoism\">Taoísmo</option>
                        <option value=\"Confucianism\">Confucianismo</option>                
                        <option value=\"Sikhism\">Sijismo</option>
                        <option value=\"Jainism\">Jainismo</option>
                        <option value=\"Druze\">Druso</option>
        ...
        echo "
                ...
                <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                    <option value=\"No formal schooling\">Sin escolaridad formal</option>
                    <option value=\"Finished primary school\">Escuela primaria concluida</option>
                    <option value=\"Finished high school\">Escuela secundaria concluida</option>
                    <option value=\"Finished a course following school\">Concluí un curso después de la educación básica</option>
                    <option value=\"Finished undergraduate university degree\">Escolaridad a nivel licenciatura concluida</option>
                    <option value=\"Finished postgraduate university degree\">Escolaridad a nivel de posgrado concluida</option>
                </select>
            </div>
                <br>
        ...
        echo "
                ...
                <br>
                <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">Si
                <div id=\"health_yes\" style=\"display:none;\">
                    <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                        <option value=\"Medical Doctor\">Doctorado en medicina</option>
                        <option value=\"Scientific Researcher\">Investigación científica</option>
                        <option value=\"Nurse\">Enfermería</option>
                        <option value=\"Allied health worker\">Trabajador aliado de la salud</option>
                        <option value=\"Other role at hospital/medical centre\">Otra función en un hospital/centro médico</option>
        ...
        echo "
                <br>
                <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have never heard of it\" onclick=\"show8()\" required value=\"I have never heard of it\">Jamás he escuchado al respecto
                <br>
                <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a little about it\" onclick=\"show8()\">He escuchado un poco al respecto
                <br>
                <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a lot about it\" onclick=\"show8()\">He escuchado mucho al respecto
            </div>
                <br>
        ...
        echo "
                <br>
                <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">Por encima del salario promedio
                <br>
                <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">Salario promedio
                <br>
                <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">Por debajo del salario promedio
            </div>
                <br>
        ...
        echo "
                ...
                <br>
                <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">Si
        ...
        echo "
                    ...
                    <select name=\"who\">
                        ...
                        <option value=\"Another family member(s)\">Otro(s) miembro(s) de mi familia</option>
                        <option value=\"Me and a family member(s)\">Yo y un (otros) miembro(s) de mi familia</option>
                    </select>
                    <br>
                    ";
        // line 517
        ...
        echo "
                    ...
                    <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                        <option value=\"Cystic Fibrosis\">Fibrosis quística</option>
                        <option value=\"Huntington’s Disease\">Enfermedad de Huntington</option>
                        <option value=\"Muscular Dystrophy\">Distrofia muscular</option>
                        <option value=\"Sickle Cell Anaemia\">Anemia de células falciformes</option>
                        <option value=\"Beta Thalassemia\">Talasemia beta</option>
                        <option value=\"Haemophilia\">Hemofilia</option>
                        <option value=\"Tay Sachs Disease\">Enfermedad de Tay Sachs</option>
                        <option value=\"Fragile X Syndrome\">Síndrome X frágil</option>
                        <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">Síndrome de Down, síndrome de Edward, síndrome de Patau</option>
                        <option value=\"Other\">Otro</option>
                    </select>
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_spanish.html.twig";
    }
    ...
    {
        return array (  587 => 517,  576 => 509,  565 => 501,  552 => 491,  539 => 481,  516 => 461,  500 => 448,  467 => 418,  446 => 400,  187 => 144,  61 => 21,  49 => 12,  44 => 10,  40 => 8,  37 => 7,  32 => 4,  29 => 3,);
    }
}
