...
/* GeneQuestionnaireBundle:User:user_french.html.twig */
class __TwigTemplate_176bca5916206ea1ed2dc920cfe6a3eeb173307a2966df5137e3f42608da5d4f extends Twig_Template
{
...
";
    ...
    <form action=\"";
        // line 10
        echo $this->env->getExtension('routing')->getPath("gene_questionnaire_user_save_fr");
        echo "\" method=\"post\">
        <div>
            ";
        // line 12
        ...
        echo "
            ...
            <select name=\"ethnicity\" onclick=\"show4()\">
                <option value=\"Mixed Race\">Métis</option>
                <option value=\"African/African American\">Africain/Afro-américain</option>
                <option value=\"Asian Indian\">Indien d’Asie</option>
                <option value=\"Caucasian (European)\">Caucasien (Européen)</option>
                <option value=\"Caucasian (Middle East)\">Caucasien (Moyen-Orient)</option>
                <option value=\"Hispanic, Latino or Spanish\">Hispanique, Latino</option>
                <option value=\"Indigenous Australian\">Indigène australien</option>
                <option value=\"Native American\">Indien d’Amérique</option>
                <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">Asiatique du nord-est (Mongol, Tibétaine, Coréen, Japonais, etc...)</option>
                <option value=\"Pacific (Polynesian, micronesian, etc)\">Pacifique (Polynésien, Micronésien, etc...)</option>                
                <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">Asiatique du sud-est -Chinois, Thaï, Malaisienne, Philippine, etc...)</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"no\" onclick=\"show4_no()\" required value=\"no\">Non
            <br>
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">Oui

            <div id=\"religious_yes\" style=\"display:none;\">
                <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">
                    <option value=\"Christian - Protestant/Anglican\">Chrétien - Protestant/Anglican</option>
                    <option value=\"Christian - Catholic\">Chrétien - Catholique</option>
                    <option value=\"Christian - Other\">Chrétien - Autre</option>
                    <option value=\"Muslim\">Musulman</option>
                    <option value=\"Jewish\">Juif</option>
                    <option value=\"Buddhist\">Bouddhiste</option>
                    <option value=\"Hindu\">Hindouiste</option>
                    <option value=\"Shinto\">Shintoïste</option>
                    <option value=\"Taoism\">Taoïste</option>
                    <option value=\"Confucianism\">Confucianiste</option>                
                    <option value=\"Sikhism\">Sikh</option>
                    <option value=\"Jainism\">Djaïniste</option>
        ...
        echo "
            ...
            <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                <option value=\"No formal schooling\">Aucune éducation scolaire</option>
                <option value=\"Finished primary school\">École primaire</option>
                <option value=\"Finished high school\">Lycée</option>
                <option value=\"Finished a course following school\">Cours en dehors de l’école</option>
                <option value=\"Finished undergraduate university degree\">Master</option>
                <option value=\"Finished postgraduate university degree\">Doctorat</option>
            </select>
        </div>
        <br>
        ...
        echo "
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"no\" onclick=\"show6_no()\" required value=\"no\">Non
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">Oui

            <div id=\"health_yes\" style=\"display:none;\">
                <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                    <option value=\"Medical Doctor\">Docteur / Doctoresse</option>
                    <option value=\"Scientific Researcher\">Scientifique</option>
                    <option value=\"Nurse\">Infirmier/ infirmière</option>
                    <option value=\"Allied health worker\">Auxiliaire de médecine</option>
                    <option value=\"Other role at hospital/medical centre\">Autre rôle dans un hôpital / centre médical</option>
                    <option value=\"Other\">Autre</option>
                </select>
        ...
        echo "
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have never heard of it\" onclick=\"show8()\" required value=\"I have never heard of it\">Je n’en ai jamais entendu parler
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a little about it\" onclick=\"show8()\">J’en ai un peu entendu parler
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a lot about it\" onclick=\"show8()\">J’en ai beaucoup entendu parler
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">Au dessus de la moyenne financière
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">Dans la moyenne financière
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">En dessous de la moyenne financière
        ...
        echo "
            ...
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"no\" onclick=\"show9_no()\" required value=\"no\">Non
            <br>
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">Oui
        ...
        echo "
                ...
                <select name=\"who\">
                    ...
                    <option value=\"Another family member(s)\">Un autre membre de ma famille</option>
                    <option value=\"Me and a family member(s)\">Moi et un membre de ma famille</option>
                </select>
                <br>
                ";
        // line 518
        ...
        echo "
                ...
                <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                    <option value=\"Cystic Fibrosis\">Mucoviscidose</option>
                    <option value=\"Huntington’s Disease\">Maladie de Huntington</option>
                    <option value=\"Muscular Dystrophy\">Dystrophie musculaire</option>
                    <option value=\"Sickle Cell Anaemia\">Hydroxyurée</option>
                    <option value=\"Beta Thalassemia\">Cardiomyopathie par surcharge en fer</option>
                    <option value=\"Haemophilia\">Hémophilie</option>
                    <option value=\"Tay Sachs Disease\">Hyperacousie</option>
                    <option value=\"Fragile X Syndrome\">Syndrome de l’X fragile</option>
                    <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">Syndrome de Down, Syndrome d’Edward, Syndrome de Patau</option>
                    <option value=\"Other\">Autre</option>
                </select>
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_french.html.twig";
    }
    ...
    {
        return array (  588 => 518,  577 => 510,  566 => 502,  551 => 490,  538 => 480,  515 => 460,  499 => 447,  467 => 418,  446 => 400,  187 => 144,  61 => 21,  49 => 12,  44 => 10,  40 => 8,  37 => 7,  32 => 4,  29 => 3,);
    }
}
