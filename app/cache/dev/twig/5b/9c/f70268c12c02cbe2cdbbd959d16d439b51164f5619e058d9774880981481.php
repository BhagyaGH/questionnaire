...
/* GeneQuestionnaireBundle:User:user_turkish.html.twig */
class __TwigTemplate_5b9cf70268c12c02cbe2cdbbd959d16d439b51164f5619e058d9774880981481 extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 8
        echo "
    <h2>Bize kendinizden bahsedin...</h2>
    <form action=\"";
        // line 10
        echo $this->env->getExtension('routing')->getPath("gene_questionnaire_user_save_tr");
        echo "\" method=\"post\">
        <div>
            ";
        // line 12
        ...
        echo "
            ...
            <select name=\"ethnicity\" onclick=\"show4()\">
                <option value=\"Mixed Race\">Melez</option>
                <option value=\"African/African American\">Afrikalı/Afro Amerikalı</option>
                <option value=\"Asian Indian\">Hint-Asyalı</option>
                <option value=\"Caucasian (European)\">Kafkasyalı (Avrupalı)</option>
                <option value=\"Caucasian (Middle East)\">Kafkasyalı (Orta Doğulu)</option>
                <option value=\"Hispanic, Latino or Spanish\">Hispanik, Latin veya İspanyol</option>
                <option value=\"Indigenous Australian\">Avusturalya Yerlisi</option>
                <option value=\"Native American\">Amerika Yerlisi</option>
                <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">Güney Doğu Asyalı (Moğol, Tibet, Koreli, Japon, vs)</option>
                <option value=\"Pacific (Polynesian, micronesian, etc)\">Pasifik (Polinezyalı, mikronezyalı, vs)</option>                
                <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">Güney Doğu Asyalı (Çinli, Tay, Malezyalı, Filipinli, vs)</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"no\" onclick=\"show4_no()\" required value=\"no\">Hayır
            <br>
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">Evet

            <div id=\"religious_yes\" style=\"display:none;\">
                <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">
                    <option value=\"Christian - Protestant/Anglican\">Hristiyan Protestan/Anglikan</option>
                    <option value=\"Christian - Catholic\">Hristiyan Katolik</option>
                    <option value=\"Christian - Other\">Hristiyan Diğer</option>
                    <option value=\"Muslim\">Müslüman</option>
                    <option value=\"Jewish\">Musevi</option>
                    <option value=\"Buddhist\">Budist</option>
                    <option value=\"Hindu\">Hindu</option>
                    <option value=\"Shinto\">Şinto</option>
                    <option value=\"Taoism\">Taoizm</option>
                    <option value=\"Confucianism\">Konfüçyüsçülük</option>                
                    <option value=\"Sikhism\">Sihizim</option>
                    <option value=\"Jainism\">Jainizm</option>
                    <option value=\"Druze\">Dürzi</option>
        ...
        echo "
            ...
            <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                <option value=\"No formal schooling\">Herhangi bir resmi eğitimim yok</option>
                <option value=\"Finished primary school\">İlkokulu bitirdim</option>
                <option value=\"Finished high school\">Liseyi bitirdim</option>
                <option value=\"Finished a course following school\">Okulu müteakip bir kurs bitirdim</option>
                <option value=\"Finished undergraduate university degree\">Üniversitede lisans programını bitirdim</option>
                <option value=\"Finished postgraduate university degree\">Üniversitede yüksek lisans programını bitirdim</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"no\" onclick=\"show6_no()\" required value=\"no\">Hayır
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">Evet

            <div id=\"health_yes\" style=\"display:none;\">
                <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                    <option value=\"Medical Doctor\">Tıbbi Doktor</option>
                    <option value=\"Scientific Researcher\">Bilimsel Araştırmacı</option>
                    <option value=\"Nurse\">Hemşire</option>
                    <option value=\"Allied health worker\">Yardımcı sağlık görevlisi</option>
                    <option value=\"Other role at hospital/medical centre\">Hastanede/sağlık merkezinde diğer bir rol</option>
                    <option value=\"Other\">Diğer</option>
                </select>
        ...
        echo "
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have never heard of it\" onclick=\"show8()\" required value=\"I have never heard of it\">Hiç duymadım
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a little about it\" onclick=\"show8()\">Biraz fikrim var
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a lot about it\" onclick=\"show8()\">Hakkında çok şey duydum
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">Genel refah düzeyinin üstünde
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">Genel refah düzeyinde
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">Genel refah düzeyinin altında
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"no\" onclick=\"show9_no()\" required value=\"no\">Hayır
            <br>
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">Evet
        ...
        echo "
                ...
                <select name=\"who\">
                    ...
                    <option value=\"Another family member(s)\">Diğer aile üyesi veya üyeleri</option>
                    <option value=\"Me and a family member(s)\">Ben ve diğer bir aile üyesi/üyeleri</option>
                </select>
                <br>
                ";
        // line 518
        ...
        echo "
                ...
                <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                    <option value=\"Cystic Fibrosis\">Kistik Fibroz</option>
                    <option value=\"Huntington’s Disease\">Huntington Hastalığı</option>
                    <option value=\"Muscular Dystrophy\">Kas Distrofisi</option>
                    <option value=\"Sickle Cell Anaemia\">Orak Hücre Anemisi</option>
                    <option value=\"Beta Thalassemia\">Akdeniz Anemisi</option>
                    <option value=\"Haemophilia\">Hemofili</option>
                    <option value=\"Tay Sachs Disease\">Tay Sachs Hastalığı</option>
                    <option value=\"Fragile X Syndrome\">Frajil X Sendromu</option>
                    <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">Down Sendromu, Edward Sendromu, Patau Sendromu</option>
                    <option value=\"Other\">Diğer</option>
                </select>
        ...
        <input class=\"btn btn-primary btn-lg\" type=\"submit\" id=\"submitButton\" value=\"Submit\" style=\"display:none;\">
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_turkish.html.twig";
    }
    ...
    {
        return array (  588 => 518,  577 => 510,  566 => 502,  552 => 491,  539 => 481,  515 => 460,  499 => 447,  467 => 418,  446 => 400,  187 => 144,  61 => 21,  49 => 12,  44 => 10,  40 => 8,  37 => 7,  32 => 4,  29 => 3,);
    }
}
