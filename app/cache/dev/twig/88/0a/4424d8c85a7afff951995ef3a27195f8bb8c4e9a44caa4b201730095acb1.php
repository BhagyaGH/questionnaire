...
/* GeneQuestionnaireBundle:User:user_hindi.html.twig */
class __TwigTemplate_880a4424d8c85a7afff951995ef3a27195f8bb8c4e9a44caa4b201730095acb1 extends Twig_Template
{
    ...
    <form action=\"";
        // line 6
        echo $this->env->getExtension('routing')->getPath("gene_questionnaire_user_save_hn");
        echo "\" method=\"post\">
        <div>
            ";
        // line 8
        ...
        echo "
            ...
            <select name=\"ethnicity\" onclick=\"show4()\">
                <option value=\"Mixed Race\">मिश्र जाति</option>
                <option value=\"African/African American\">अफ्रीकी / अफ्रीकी अमेरिकी</option>
                <option value=\"Asian Indian\">भारतीय/एशियाई</option>
                <option value=\"Caucasian (European)\">श्वेतजाति (यूरोपीय)</option>
                <option value=\"Caucasian (Middle East)\">श्वेतजाति (मध्यपूर्व)</option>
                <option value=\"Hispanic, Latino or Spanish\">हिस्पैनिकलातीनोयास्पेनिश</option>
                <option value=\"Indigenous Australian\">मूलऑस्ट्रेलियाई</option>
                <option value=\"Native American\">मूलअमेरिकी</option>
                <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">उत्तर-पूर्वएशियाई (मंगोल, तिब्बती, कोरियाई, जापानी, आदि)</option>
                <option value=\"Pacific (Polynesian, micronesian, etc)\">प्रशांत (पॉलिनीषियन, माइक्रोनेशियन, आदि)</option>                
                <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">दक्षिणपूर्वएशियाई (चीनी, थाई, मलय, फिलिपिनो,आदि)</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"no\" onclick=\"show4_no()\" required value=\"no\">नहीं
            <br>
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">हाँ

            <div id=\"religious_yes\" style=\"display:none;\">
                <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">
                    <option value=\"Christian - Protestant/Anglican\">ईसाई- प्रोटेस्टेंट / अँग्रेज़ी</option>
                    <option value=\"Christian - Catholic\">ईसाई- कैथोलिक</option>
                    <option value=\"Christian - Other\">ईसाई- अन्य</option>
                    <option value=\"Muslim\">मुस्लिम</option>
                    <option value=\"Jewish\">यहूदी</option>
                    <option value=\"Buddhist\">बौद्ध</option>
                    <option value=\"Hindu\">हिन्दू</option>
                    <option value=\"Shinto\">शिंटो</option>
                    <option value=\"Taoism\">ताओधर्म</option>
                    <option value=\"Confucianism\">कन्फ्यूशीवाद</option>                
                    <option value=\"Sikhism\">सिखधर्म</option>
                    <option value=\"Jainism\">जैनधर्म</option>
                    <option value=\"Druze\">ड्रूज़</option>
        ...
        echo "
            ...
            <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                <option value=\"No formal schooling\">कोईऔपचारिकस्कूलीशिक्षानहीं</option>
                <option value=\"Finished primary school\">प्राथमिकविद्यालयपूरीकी</option>
                <option value=\"Finished high school\">उच्चविद्यालयपूरीकी</option>
                <option value=\"Finished a course following school\">स्कूलकेबादएककोर्ससमाप्तकिया</option>
                <option value=\"Finished undergraduate university degree\">विश्वविद्यालयकेस्नातक(undergraguate)कीडिग्रीली</option>
                <option value=\"Finished postgraduate university degree\">स्नातकोत्तर(postgraduate)विश्वविद्यालयकीडिग्रीली</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"no\" onclick=\"show6_no()\" required value=\"no\">नहीं
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">हाँ

            <div id=\"health_yes\" style=\"display:none;\">
                <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                    <option value=\"Medical Doctor\">चिकित्सक</option>
                    <option value=\"Scientific Researcher\">वैज्ञानिकशोधकर्ता</option>
                    <option value=\"Nurse\">नर्स</option>
                    <option value=\"Allied health worker\">अन्यस्वास्थ्यकार्यकर्ता</option>
                    <option value=\"Other role at hospital/medical centre\">अस्पताल/मेडिकलसेंटरमेंअन्यभूमिका</option>
                    <option value=\"Other\">अन्य</option>
                </select>
        ...
        echo "
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have never heard of it\" onclick=\"show8()\" required value=\"I have never heard of it\">मैंनेइसकेबारेमेंकभीनहींसुना|
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a little about it\" onclick=\"show8()\">मैंने  इसकेबारेमेंथोड़ासासुनाहै|
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a lot about it\" onclick=\"show8()\">मैंनेइसकेबारेमेंकाफीसुनाहै|
        </div>
        <br>
        ...
        echo "
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">औसतधनराशिकेऊपर
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">औसतधनराशि
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">औसतधनराशि  सेनीचे
        ...
        echo "
            ...
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"no\" onclick=\"show9_no()\" required value=\"no\">नहीं
            <br>
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">हाँ
        ...
        echo "
                <br>
                <select name=\"who\">
                    <option value=\"Me\">मैं</option>
                    <option value=\"Another family member(s)\">परिवार का अन्य सदस्य</option>
                    <option value=\"Me and a family member(s)\">मैं और परिवार का एक सदस्य</option>
                </select>
                <br>
                ";
        // line 515
        ...
        echo "
                ...
                <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                    <option value=\"Cystic Fibrosis\">सिस्टिकफाइब्रोसिस</option>
                    <option value=\"Huntington’s Disease\">हनटिंग्टनरोग</option>
                    <option value=\"Muscular Dystrophy\">मांसपेशीयदुर्विकास (Muscular Dystrophy)</option>
                    <option value=\"Sickle Cell Anaemia\">रक्तकीलालकोशिकाओंकीकमी (Sickle Cell Ananemia)</option>
                    <option value=\"Beta Thalassemia\">बीटाथैलेसीमिया</option>
                    <option value=\"Haemophilia\">हीमोफीलिया</option>
                    <option value=\"Tay Sachs Disease\">टेसेक्सबीमारी</option>
                    <option value=\"Fragile X Syndrome\">कमजोरएक्सलक्षण ( Fragile X Syndrome)</option>
                    <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">डाउनसिंड्रोम, एडवर्ड'ससिंड्रोम, पतौसिंड्रोम</option>
                    <option value=\"Other\">अन्य</option>
                </select>
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_hindi.html.twig";
    }
    ...
    {
        return array (  580 => 515,  569 => 507,  558 => 499,  544 => 488,  531 => 478,  507 => 457,  491 => 444,  459 => 415,  437 => 396,  178 => 140,  52 => 17,  40 => 8,  35 => 6,  31 => 4,  28 => 3,);
    }
}
