...
/* GeneQuestionnaireBundle:User:user_chinese.html.twig */
class __TwigTemplate_c3a947844acaf737e0e45d7e9fcaa229da251562bc96957f1cbdba75758e89af extends Twig_Template
{
    ...
    <form action=\"";
        ...
        echo "
            ...
            <select name=\"ethnicity\" onclick=\"show4()\">
                ...
                <option value=\"African/African American\">非裔美籍</option>
                <option value=\"Asian Indian\">印度裔</option>
                <option value=\"Caucasian (European)\">白种人（欧洲）</option>
                <option value=\"Caucasian (Middle East)\">白种人（中东）</option>
                <option value=\"Hispanic, Latino or Spanish\">西班牙，拉美裔</option>
                <option value=\"Indigenous Australian\">澳大利亚土著人</option>
                <option value=\"Native American\">美国人</option>
                <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">东北亚裔（蒙古，西藏，韩国，日本等）</option>
                <option value=\"Pacific (Polynesian, micronesian, etc)\">太平洋（波利尼西亚，密克罗尼西亚等）</option>                
                <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">东南亚裔（中国，泰国，马来，菲律宾等）</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"no\" onclick=\"show4_no()\" required value=\"no\">无
            <br>
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">有

            <div id=\"religious_yes\" style=\"display:none;\">
                <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">
                    <option value=\"Christian - Protestant/Anglican\">基督教-新教/英国国教</option>
                    <option value=\"Christian - Catholic\">基督教-天主教</option>
                    <option value=\"Christian - Other\">基督教-其他</option>
                    <option value=\"Muslim\">穆斯林</option>
                    <option value=\"Jewish\">犹太教</option>
                    <option value=\"Buddhist\">佛教</option>
                    <option value=\"Hindu\">印度教</option>
                    <option value=\"Shinto\">日本神道教</option>
                    <option value=\"Taoism\">道教</option>
                    <option value=\"Confucianism\">儒家</option>                
                    <option value=\"Sikhism\">锡克教</option>
                    <option value=\"Jainism\">耆那教</option>
                    <option value=\"Druze\">德鲁兹教派</option>
        ...
        echo "
            ...
            <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                <option value=\"No formal schooling\">未上过正规学校</option>
                <option value=\"Finished primary school\">小学毕业</option>
                <option value=\"Finished high school\">高中毕业</option>
                <option value=\"Finished a course following school\">仅完成学校学业</option>
                <option value=\"Finished undergraduate university degree\">大学毕业</option>
                <option value=\"Finished postgraduate university degree\">研究生毕业</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"no\" onclick=\"show6_no()\" required value=\"no\">无
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">有

            <div id=\"health_yes\" style=\"display:none;\">
                <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                    <option value=\"Medical Doctor\">医生</option>
                    <option value=\"Scientific Researcher\">科研工作者</option>
                    <option value=\"Nurse\">护士</option>
                    <option value=\"Allied health worker\">合作医疗工作者</option>
                    <option value=\"Other role at hospital/medical centre\">医院或其他医疗中心工作者</option>
                    <option value=\"Other\">其他</option>
                </select>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">平均水平之上
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">平均水平
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">低于平均水平
        ...
        echo "
            ...
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"no\" onclick=\"show9_no()\" required value=\"no\">无
            <br>
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">有
        ...
        echo "
                ...
                <select name=\"who\">
                    ...
                    <option value=\"Another family member(s)\">其他家庭成员</option>
                    <option value=\"Me and a family member(s)\">我和另外的家庭成员</option>
                </select>
                <br>
                ";
        // line 519
        ...
        echo "
                ...
                <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                    <option value=\"Cystic Fibrosis\">囊胞性纤维症</option>
                    <option value=\"Huntington’s Disease\">亨廷顿病</option>
                    <option value=\"Muscular Dystrophy\">肌肉萎缩症</option>
                    <option value=\"Sickle Cell Anaemia\">镰状细胞贫血</option>
                    <option value=\"Beta Thalassemia\">地中海贫血</option>
                    <option value=\"Haemophilia\">血友病</option>
                    <option value=\"Tay Sachs Disease\">泰-萨克斯病</option>
                    <option value=\"Fragile X Syndrome\">X染色体易损综合征</option>
                    <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">唐氏综合症，爱德华综合症，三体综合征</option>
                    <option value=\"Other\">其他</option>
                </select>
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_chinese.html.twig";
    }
    ...
    {
        return array (  589 => 519,  578 => 511,  567 => 503,  552 => 491,  538 => 480,  514 => 459,  498 => 446,  466 => 417,  445 => 399,  186 => 143,  60 => 20,  48 => 11,  43 => 9,  40 => 8,  37 => 7,  32 => 4,  29 => 3,);
    }
}
