...
/* GeneQuestionnaireBundle:User:user_japanese.html.twig */
class __TwigTemplate_e257f124cd73e2b43502bc3a9a4dc459cc1998e17da098dde670fd2c2e42f429 extends Twig_Template
{
...
";
    ...
    <form action=\"";
        // line 10
        echo $this->env->getExtension('routing')->getPath("gene_questionnaire_user_save_jp");
        echo "\" method=\"post\">
        <div>
            ";
        // line 12
        ...
        echo "
            ...
            <select name=\"ethnicity\" onclick=\"show4()\">
                ...
                <option value=\"African/African American\">アフリカ人／アフリカ系アメリカ人</option>
                <option value=\"Asian Indian\">アジア系インド人</option>
                <option value=\"Caucasian (European)\">白人（ヨーロッパ系）</option>
                <option value=\"Caucasian (Middle East)\">白人（中東系）</option>
                <option value=\"Hispanic, Latino or Spanish\">ヒスパニック、ラテン系またはスペイン人</option>
                <option value=\"Indigenous Australian\">原住民オーストラリア人</option>
                <option value=\"Native American\">アメリカ先住民</option>
                <option value=\"North East Asian (Mongol, Tibetan, Korean, Japanese, etc)\">北東アジア（モンゴル人、チベット族、韓国人、日本人、など）</option>
                <option value=\"Pacific (Polynesian, micronesian, etc)\">大西洋（ポリネシア人、ミクロネシア人、など）</option>                
                <option value=\"South East Asian (Chinese, Thai, Malay, Filipino, etc)\">南東アジア（中国人、タイ人、マレーシア人、フィリピン人、など）</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"no\" onclick=\"show4_no()\" required value=\"no\">いいえ
            <br>
            <input type=\"radio\" name=\"isRel\" id=\"isRel\" value=\"yes\" onclick=\"show4_yes()\">はい

            <div id=\"religious_yes\" style=\"display:none;\">
                <select name=\"rel\" id=\"rel\" onclick=\"show4_5()\">
                    <option value=\"Christian - Protestant/Anglican\">キリスト教—プロテスタント／英国国教会派</option>
                    <option value=\"Christian - Catholic\">キリスト教—カトリック教会</option>
                    <option value=\"Christian - Other\">キリスト教—その他</option>
                    <option value=\"Muslim\">イスラム教</option>
                    <option value=\"Jewish\">ユダヤ教</option>
                    <option value=\"Buddhist\">仏教</option>
                    <option value=\"Hindu\">ヒンズー教</option>
                    <option value=\"Shinto\">神道</option>
                    <option value=\"Taoism\">道教</option>
                    <option value=\"Confucianism\">儒教</option>                
                    <option value=\"Sikhism\">シーク教</option>
                    <option value=\"Jainism\">ジャイナ教</option>
                    <option value=\"Druze\">ドルーズ教</option>
        ...
        echo "
            ...
            <select name=\"edu\" id=\"edu\" onclick=\"show6()\">
                <option value=\"No formal schooling\">学校教育なし</option>
                <option value=\"Finished primary school\">小学校を卒業</option>
                <option value=\"Finished high school\">高校を卒業</option>
                <option value=\"Finished a course following school\">学校卒業に続くコースを終了</option>
                <option value=\"Finished undergraduate university degree\">４年制大学を卒業</option>
                <option value=\"Finished postgraduate university degree\">大学院を卒業</option>
            </select>
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"no\" onclick=\"show6_no()\" required value=\"no\">いいえ
            <br>
            <input type=\"radio\" name=\"isHealth\" id=\"isHealth\" value=\"yes\" onclick=\"show6_yes()\">はい
            <div id=\"health_yes\" style=\"display:none;\">
                <select name=\"heal_yes\" id=\"heal_yes\" onclick=\"show6_7()\">
                    <option value=\"Medical Doctor\">医師</option>
                    <option value=\"Scientific Researcher\">科学研究者</option>
                    <option value=\"Nurse\">看護師</option>
                    <option value=\"Allied health worker\">保険ワーカー</option>
                    <option value=\"Other role at hospital/medical centre\">病院／医療センターでの他の仕事</option>
                    <option value=\"Other\">その他</option>
                </select>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have never heard of it\" onclick=\"show8()\" required value=\"I have never heard of it\">聞いたことがない
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a little about it\" onclick=\"show8()\">少しだけなら聞いたことがある
            <br>
            <input type=\"radio\" name=\"gene\" id=\"gene\" value=\"I have heard a lot about it\" onclick=\"show8()\">たくさん聞いたことがある
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Above average wealth\" onclick=\"show9()\" required value=\"Above average wealth\">平均よりも上
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Average wealth\" onclick=\"show9()\">平均
            <br>
            <input type=\"radio\" name=\"fin\" id=\"fin\" value=\"Below average wealth\" onclick=\"show9()\">平均よりも下
        </div>
        <br>
        ...
        echo "
            ...
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"no\" onclick=\"show9_no()\" required value=\"no\">いいえ
            <br>
            <input type=\"radio\" name=\"inh\" id=\"inh\" value=\"yes\" onclick=\"show9_yes()\">はい
        ...
        echo "
                ...
                <select name=\"who\">
                    ...
                    <option value=\"Another family member(s)\">自分以外の家族メンバー（複数）</option>
                    <option value=\"Me and a family member(s)\">自分と家族（複数）病</option>
                </select>
                <br>
                ";
        // line 518
        ...
        echo "
                ...
                <select name=\"what\" id=\"what\" onclick=\"show9_10()\">
                    <option value=\"Cystic Fibrosis\">嚢胞性繊維証</option>
                    <option value=\"Huntington’s Disease\">ハンティントン病</option>
                    <option value=\"Muscular Dystrophy\">筋ジストロフィー</option>
                    <option value=\"Sickle Cell Anaemia\">鎌状赤血球貧血</option>
                    <option value=\"Beta Thalassemia\">地中海性貧血</option>
                    <option value=\"Haemophilia\">血友病</option>
                    <option value=\"Tay Sachs Disease\">テイ•サックス病</option>
                    <option value=\"Fragile X Syndrome\">脆弱X症候群</option>
                    <option value=\"Down’s Syndrome, Edward’s Syndrome, Patau Syndrome\">ダウン症候群、エドワード症候群、パトー症候群</option>
                    <option value=\"Other\">その他</option>
                </select>
...
";
    ...
    {
        return "GeneQuestionnaireBundle:User:user_japanese.html.twig";
    }
    ...
    {
        return array (  588 => 518,  577 => 510,  566 => 502,  552 => 491,  538 => 480,  515 => 460,  499 => 447,  467 => 418,  446 => 400,  187 => 144,  61 => 21,  49 => 12,  44 => 10,  40 => 8,  37 => 7,  32 => 4,  29 => 3,);
    }
}
