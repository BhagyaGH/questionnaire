...
class UserFrenchController extends Controller {

    public function frenchAction() {
        $questions = $this->getDoctrine()->getManager()->getRepository(
                        'GeneQuestionnaireBundle:UserQuestionsFrench')->findAll();
        return $this->render('GeneQuestionnaireBundle:User:user_french.html.twig', array('questions' => $questions));
    }
    ...
    public function saveUserAction(Request $request) {
        if ($request->getMethod() == 'POST') {
            ...
            return $this->redirect($this->generateUrl('gene_questionnaire_user_q_fr', array('user' => $user->getId())));
        }
    }
