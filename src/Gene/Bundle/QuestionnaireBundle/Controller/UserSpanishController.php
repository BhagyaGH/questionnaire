...
class UserSpanishController extends Controller {

    public function spanishAction() {
        $questions = $this->getDoctrine()->getManager()->getRepository(
                        'GeneQuestionnaireBundle:UserQuestionsSpanish')->findAll();
        return $this->render('GeneQuestionnaireBundle:User:user_spanish.html.twig', array('questions' => $questions));
    }
    ...
    public function saveUserAction(Request $request) {
        if ($request->getMethod() == 'POST') {
            ...
            return $this->redirect($this->generateUrl('gene_questionnaire_user_q_es', array('user' => $user->getId())));
        }
    }
